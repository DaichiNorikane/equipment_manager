...
with checks as (
  ...
  union all select 'table: equipment_units', (to_regclass('public.equipment_units') is not null), null
  ...
  union all select 'event_usages.column: updated_at', exists (select 1 from information_schema.columns where table_schema='public' and table_name='event_usages' and column_name='updated_at'), 'from 010_update_propagation.sql'
  union all select 'rentals.column: updated_at', exists (select 1 from information_schema.columns where table_schema='public' and table_name='rentals' and column_name='updated_at'), 'from 010_update_propagation.sql'
